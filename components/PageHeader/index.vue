<template>
  <header class="intro text-center">
    ...
    <div class="intro__content">
      <nuxt-link to="/" class="intro__avatar" title="回到首頁">
        <div class="avatar-wrapper">
          <div class="avatar-glow" />
          <img alt="MonkeyBinBin" src="~/assets/img/avatar.jpg" class="avatar-image" />
...
.intro {
  ...
  // 展平成 hover 狀態下的 avatar-ring、avatar-glow、avatar-image、avatar-label
  &__avatar:hover .avatar-wrapper .avatar-ring {
    transform: scale(1.2) rotate(180deg);
    opacity: 1;
    box-shadow: 0 0 30px rgba($header-primary, 0.6);
  }

  &__avatar:hover .avatar-wrapper .avatar-glow {
    opacity: 1;
    transform: scale(1.3);
  }
  ...
  &__text {
    ...
    .main-title {
      ...
      &::after {
        ...
        opacity: 0.6;
        animation: tech-line 2s ease-in-out infinite alternate;
      }
    }
  }
}
